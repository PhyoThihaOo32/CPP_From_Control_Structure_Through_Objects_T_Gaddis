...
public:
    ...
    string getStar1() const;
    string getStar2() const;
    string getProducer() const;
    string getDirector() const;
    string getProductionCo() const;
...
{
    osObject << video.videoTitle << endl;
    osObject << video.movieStar1 << endl
             << video.movieStar2 << endl;
    osObject << video.movieProducer << endl;
    osObject << video.movieDirector << endl;
    osObject << video.movieProductionCo << endl;
    osObject << video.copiesInStock
             << endl;
    return osObject;
}

// getter method
string videoType::getStar1() const
{
    return movieStar1;
}
string videoType::getStar2() const
{
    return movieStar2;
}
...
string videoType::getProductionCo() const
{
