...
int main(int argc, char *argv[])
{
    ...
    if (error == 1) {
        cout << "You didn't enter the coordinates.\n";
    } else if (error == 2) {
        cout << "Invalid input (not a number).\n";
    } else if (error == 3) {
        cout << "Coordinates must be in range [0,9].\n";
    }
...
- updated exception handlings in each validation
- throw 1 - if arg is less than 2, throw 2 if the arg is not digit, throw 3 if the arg is not in range[0,9]
