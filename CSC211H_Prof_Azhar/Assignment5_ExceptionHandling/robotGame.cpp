...
Assignment5- added exception handling in input validation
*/
...
int main(int argc, char **argv)
{
    ...
    catch(int error){   // catch error of int 
        if(error == 1) cout << "Number of Input is less than 2" << endl;
        else if(error == 2) cout << "Input is not a digit." << endl;
        else if(error == 3) cout << "Input is not in range [0,9]." << endl;
    }
