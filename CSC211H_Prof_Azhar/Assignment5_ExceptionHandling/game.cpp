...
void validateInput(int, char **, vector<int> &); // added exception handling in input validation
...
int main(int argc, char **argv)
{
    ...
    do
    {
        ...
        if(error == 1){
            cout << "Number of input is less than 2" << endl;
        }
        if(error == 2){
            cout << "Input is not a digit" << endl;
        }
        if(error == 3){
            cout << "Input is not in range [0,9]" << endl;
        }
    }
...
- added exceptin handling in input validation 
- 1 if the number of input is less than 1
- 2 if the input is not digit
- 3 if the input is not in range [0, 9]
