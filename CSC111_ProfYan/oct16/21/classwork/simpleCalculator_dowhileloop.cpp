/*
This is a simple interger arithmetic calculator program _ using do while loop. [ but using switch statment]
...
int main()
{
    ...
    do
    {
        ...
        cout << "Enter 'Q' or 'q'  to quit. Or Type any character to continue.";
        cin >> user_option;
